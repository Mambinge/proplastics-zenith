      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
          {featuredCategories.map((category, index) => (
            ...
            >
              <div
                className="bg-card rounded-2xl overflow-hidden border border-border hover:border-primary/50 transition-all duration-300 hover:shadow-xl hover:shadow-primary/5 group h-full"
              >
        ...
        <ScrollReveal animation="reveal-scale" delay={400}>
          <div className="p-8 rounded-2xl bg-primary text-primary-foreground text-center relative overflow-hidden">
